*&---------------------------------------------------------------------*
*& Report Z_TEC_22_2_LAB15_G05_02
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT Z_TEC_22_2_LAB15_G05_02.
...
SELECTION-SCREEN COMMENT /1(30) titulo3.
PARAMETERS : Ltname AS CHECKBOX DEFAULT 'X'.
PARAMETERS : Ftname AS CHECKBOX DEFAULT 'X'.
PARAMETERS : Address AS CHECKBOX DEFAULT 'X'.
PARAMETERS : Peso AS CHECKBOX DEFAULT 'X'.
PARAMETERS : Depart AS CHECKBOX DEFAULT 'X'.
PARAMETERS : Unit_w AS CHECKBOX DEFAULT 'X'.
PARAMETERS : Tienda AS CHECKBOX DEFAULT 'X'.
...
INITIALIZATION.
  ...
  Titulo3 = 'Parametros que desea ver'.